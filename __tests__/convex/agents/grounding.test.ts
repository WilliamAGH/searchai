...
describe("Agent Grounding Specifications", () => {
  ...
  it("should validate contextId format requirements", () => {
    ...
    console.info("[OK] ContextId validation rules verified");
  });
  ...
  it("should validate citation format in answers", () => {
    ...
    console.info("[OK] Citation format validated");
  });
  ...
  it("should validate tool call log structure", () => {
    ...
    console.info("[OK] Tool call log structure validated");
  });
  ...
  it("documents streaming event ordering and persisted metadata", () => {
    ...
    const persistedChunkShape = expect.objectContaining({
      ...
      payload: expect.objectContaining({
        ...
        answer: expect.any(String),
        webResearchSources: expect.any(Array),
      }),
  ...
  it("should validate sourcesUsed cross-referencing with keyFindings", () => {
    ...
    console.info("[OK] Source cross-referencing validated");
  });
  ...
  it("should validate short-circuit behavior for non-research queries", () => {
    ...
    console.info("[OK] Short-circuit behavior validated");
  });
...
User: Where are they based?`;
    ...
    console.info("[OK] Context propagation contract validated");
  });
});
