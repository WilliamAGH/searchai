/**
 * Sign-in modal with email/password auth and anonymous sign-in
...
/**
 * Modal for user sign-in with email/password or anonymous auth
    ...
    >
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl max-w-sm sm:max-w-md w-full mx-4 p-6 sm:p-8 border border-gray-200 dark:border-gray-700">
        ...
        <div className="text-center mb-6">
          ...
          <h2 id="signin-modal-title" className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-2">
            Sign In to SearchAI
          </h2>
        ...
        <div className="w-full">
          <form
            ...
            onSubmit={async (e) => {
              ...
              const result = await signIn("password", formData, { redirect: false } as any);
