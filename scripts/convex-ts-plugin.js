  ...
  function create(info) {
    ...
    proxy.getSemanticDiagnostics = (fileName) => {
      ...
      function checkConvexFunction(node) {
        ...
        if (!hasReturns) {
          additionalDiagnostics.push({
            ...
            messageText:
              'Convex functions should have a "returns" validator. Use v.null() for void returns.',
        ...
        if (!hasArgs) {
          additionalDiagnostics.push({
            ...
            length: node.getWidth(),
            messageText:
              'Convex functions should have an "args" validator. Use {} for no arguments.',
            category: ts.DiagnosticCategory.Warning,
      ...
      function checkForStringId(node) {
        ...
        if (
          (name.endsWith("Id") || name === "id" || name === "_id") &&
          typeText === "string"
        ) {
    ...
    proxy.getCompletionsAtPosition = (fileName, position, options) => {
      ...
      if (
        ...
        additionalCompletions.push(...createValidatorCompletions());
      }
